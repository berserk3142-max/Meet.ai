...
export function AgentsFilters({ onFiltersChange }: AgentsFiltersProps) {
    ...
    useEffect(() => { onFiltersChange?.({ search, status, page }); }, [search, status, page, onFiltersChange]);
...
export function AgentsPagination({ total, page, pageSize, totalPages }: AgentsPaginationProps) {
    ...
    return (
        <div className={cn(
            ...
            <div className="text-sm text-gray-500 font-bold">Showing {startItem}-{endItem} of {total} agents</div>
